$(function () {
    ...
    uploadCsv = (obj,callback) => {
        console.log("upload csv starting")
      $.ajax({
            ...
            getClientsByCategory({category_id:category[0].id},res=>{
                ...
                $.ajax({
                    ...
                    records:res.map(client=>{
                        ...
                        break
                        case "41489"://baru 2022-10-17
                        return {
                            phone_number:client.picwa,
                            customer_name:client.name,
                            ...obj.body,
                            body_variable2:client.name,
                            body_variable3:client.address
                        }
                        break
                        case "41414"://baru 2022-10-17
                        return {
                            phone_number:client.picwa,
                            customer_name:client.name,
                            ...obj.body,
    ...
    getParams = obj => {
        switch(obj.tplName){
            ...
            case "41456"://baru : bc_notifikasi_selesaimaintenance_tigabelasoktoberduaribuduadua
            return {
                hsm_id:"41456",
                header:[
                    {id:"phone_number",title:"phone_number"},
                ...
                body:{
                    body_variable2:$('#tpl12var2').val(),
                    body_variable1:$('#tpl12var1').val(),
                    body_variable3:$('#tpl12var3').val(),
                    body_variable4:"nama dari sistem",
                    body_variable5:"lokasi dari sistem",
                    header_variable:$('#tpl12var0').val()
                }
            }
            break;
            case "41438"://baru : bc_notifikasi_maintenance_tigabelasoktoberduaribuduadua
            return {
                hsm_id:"41438",
                header:[//phone_number,customer_name,body_variable1,body_variable2,body_variable3,body_variable4,body_variable5,header_variable
                    {id:"phone_number",title:"phone_number"},
                    {id:"customer_name",title:"customer_name"},
                    {id:"body_variable1",title:"body_variable1"},
                    {id:"body_variable2",title:"body_variable2"},
                ...
                body:{
                    body_variable2:$("#tpl11var2").val(),
                    body_variable1:$("#tpl11var1").val(),
                    body_variable3:$("#tpl11var3").val(),
                    body_variable4:"nama dari sistem",
                    body_variable5:"lokasi dari sistem",
                    header_variable:$("#tpl11var0").val(),
                }
            }
            break;
            case "41425"://baru : bc_notifikasi_penyelesaiangangguan_tigabelasoktoberduaribuduadua
            return {
                hsm_id:"41425",
                header:[//phone_number,customer_name,body_variable1,body_variable2,body_variable3,body_variable4,body_variable5,body_variable6,body_variable7,header_variable
                    {id:"phone_number",title:"phone_number"},
                    {id:"customer_name",title:"customer_name"},
                    {id:"body_variable1",title:"body_variable1"},
                    {id:"body_variable2",title:"body_variable2"},
                ...
                body:{
                    body_variable2:$("#tpl10var2").val(),
                    body_variable1:$("#tpl10var1").val(),
                    header_variable:$('#tpl10var0').val(),
                    body_variable3:$('#tpl10var3').val(),
                    body_variable4:$('#tpl10var4').val(),
                    body_variable5:$('#tpl10var5').val(),
                    body_variable6:'',
                    body_variable7:'',
                }
            }
            break
            case "41414"://baru : bc_notifikasi_gangguan_tigabelasoktoberduaribuduadua
            return {
                hsm_id:"41414",
                header:[//phone_number,customer_name,body_variable1,body_variable2,body_variable3,body_variable4,body_variable5,header_variable
                    {id:"phone_number",title:"phone_number"},
                ...
                body:{
                    body_variable2:$('#tpl9var2').val(),
                    body_variable1:$('#tpl9var1').val(),
                    body_variable3:$("#tpl9var3").val(),
                    body_variable4:"nama dari sistem",
                    body_variable5:"lokasi dari sistem",
                    header_variable:$("#tpl9var0").val()
                }
            }
            break
            case '41489'://baru : bc_notifikasi_update_gangguan_tigabelasoktoberduaribuduadua
            return {
                hsm_id:'41489',
                header:[//phone_number,customer_name,body_variable1,body_variable2,body_variable3,header_variable
                    {id:"phone_number",title:"phone_number"},
                    {id:"customer_name",title:"customer_name"},
                    {id:"body_variable1",title:'body_variable1'},
                    {id:"body_variable2",title:"body_variable2"}, //
                ...
                body:{
                    body_variable1:$("#tpl13var1").val(),
                    body_variable2:"lokasi dari sistem", //
                    body_variable3:"lokasi dari sistem", //
                    header_variable:$('#tpl13var0').val()
                }
            }
            break
...
//            url:'/getclientsbycategory/'+obj.category_id,
            url:'/get_categorychildren/'+obj.category_id,
            dataType:'json'
        })
        .done(res=>{
            callback(res)
    ...
    $("#cmbHsm").change(function(){
        ...
        switch($(this).val()){
          ...
          case "18548"://notifikasi_gangguan
          case "41456"://baru : bc_notifikasi_selesaimaintenance_tigabelasoktoberduaribuduadua
            $(".notifikasi_selesaimaintenance20221013").show()
          break;
          case "41438"://baru : bc_notifikasi_maintenance_tigabelasoktoberduaribuduadua
            $(".notifikasi_maintenance20221013").show()
          break;
          case "41425"://baru : bc_notifikasi_penyelesaiangangguan_tigabelasoktoberduaribuduadua
            $(".notifikasi_penyelesaian_gangguan20221013").show()
          break
          case "41414"://baru : bc_notifikasi_gangguan_tigabelasoktoberduaribuduadua
            $(".notifikasi_gangguan20221013").show()
          break
          case "41489"://baru : bc notifikasi_update_gangguan_tigabelasoktoberduaribuduadua
            $(".notifikasi_update_gangguan20221013").show()
            break
        }
    }) 
